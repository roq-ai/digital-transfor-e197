...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Dimension', path: '/dimensions', entity: 'dimension', service: AccessServiceEnum.PROJECT, icon: FiLayers },
    { name: 'Domain', path: '/domains', entity: 'domain', service: AccessServiceEnum.PROJECT, icon: FiGlobe },
    {
      name: 'Question',
      path: '/questions',
      entity: 'question',
